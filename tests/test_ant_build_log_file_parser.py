...
class MavenBuildLogFileParserTest(unittest.TestCase):
    ...
    def test_failed_tests_more_than_one(self):
        parser = AntBuildLogFileParser(self._get_log('ant_failed_tests_junit_2.txt'), 'DEBUG')
        parser.parse()
    ...
    def test_test_framework_junit(self):
        parser = AntBuildLogFileParser(self._get_log('ant_failed_tests_junit.txt'), 'DEBUG')
        parser.parse()

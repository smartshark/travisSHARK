...
setup(
    ...
    install_requires=['mongoengine', 'pymongo', 'requests', 'pycoshark>=1.0.15'],
    dependency_links=['git+https://github.com/smartshark/pycoSHARK.git@1.0.15#egg=pycoshark-1.0.15'],
    author='ftrautsch',

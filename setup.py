...
setup(
    ...
    install_requires=['mongoengine', 'pymongo', 'requests', 'pycoshark>=1.0.16'],
    dependency_links=['git+https://github.com/smartshark/pycoSHARK.git@1.0.16#egg=pycoshark-1.0.16'],
    author='ftrautsch',
